...
function toTengwar2(roman_string, separator, transliterate) {
    ...
    //zero on one dashes because we already compressed 
    roman_string = roman_string.replace(/c(-?)([eiy])/g,"s$1$2");    
    ...
    roman_string = roman_string.replace(/r[rR]/g,"R");
    roman_string = roman_string.replace(/([aeiou]{2})([dgmntlrRsvp])/g,"$1-$2");
    roman_string = roman_string.replace(/([aeiou]{2})([aeiou])/g, "$1-$2");
    roman_string = roman_string.replace(/([aeiou])rr/g, "$1R");
    //no d or g after n
    roman_string = roman_string.replace(/([aeiou])(n)([bcfhjklpqrRstvwxz])/g, "$1$2-$3");
    roman_string = roman_string.replace(/([aeiou])(m)([bcdfghjklpqrRstvwxz])/g, "$1$2-$3");
